...
class CreateMultiEventModel @Inject constructor(
    ...
    fun getCreateEvent(
        ...
        viewModelScope.launch {
            userCreateEvent(progressDialog, activity,eventId, title, description,event_Type,venue_Date_and_time,event_key,identify_document)
        }
    ...
    )
    {
        ...
        customerRepository.getCreateMultiEvent(eventId, title, description,event_Type,venue_Name,event_key,identify_document)
